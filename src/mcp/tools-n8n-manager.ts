...
const marketProperty = {
  type: 'string',
  description: 'Market identifier (e.g., CL, MX)'
} as const;
 ...
 * They require market-scoped credentials (e.g., N8N_{MARKET}_API_URL and N8N_{MARKET}_API_KEY).
 */
export const n8nManagementTools: ToolDefinition[] = [
  // Workflow Management Tools
  {
    ...
    inputSchema: {
      ...
      required: ['market', 'name', 'nodes', 'connections']
    }
  },
  {
